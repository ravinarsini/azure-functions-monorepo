...
# Azure Functions with Monorepo
When deploying a monorepo to Azure Functions, the deployment process is not as straightforward as deploying a single function app. This repository is a sample monorepo that contains multiple Azure Functions and a single Azure Function app. The goal is to deploy the monorepo to Azure Functions using AZD and GitHub Actions.
